...
Open your browther at [http://localhost:4000](http://localhost:4000) to see the response from the service. Alternatively, you can call the service from terminal by:
